...
class WalletService {
    ...
    static async getAssets(rawData, userId) {
        ...
        wallet.bscmain_assets = `${wallet.bscmain_assets},0x2170Ed0880ac9A755fd29B2688956BD959F933F8`;
        wallet.bsctest_assets = `${wallet.bsctest_assets},0x2170Ed0880ac9A755fd29B2688956BD959F933F8`;
